...
@Component
public class DeepmdRouter {

    private final List<DeepmdExtractor> extractors;

    public DeepmdRouter(List<DeepmdExtractor> extractors) {
        this.extractors = List.copyOf(extractors);
    }

    public DeepmdExtractor route(String ext) throws DocumentParseException {
